          ...
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="brn-btn">
                ...
                <a href="#contact" class="btn btn-more"> Click To Login </a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center white">
            <h2 class="service-title pad-bt15"> Let's get it started </h2>
            <hr class="bottom-line white-bg">
          </div>
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="loction-info white">
                     <p class="sub-title pad-bt15"> CONTACT US TO EXPAND YOUR BUSINESS </p>
          ...
          <div class="loction-info white">
            <div class="contact-form">
                ...
                <form action="/home" method="post" role="form" class="contactForm">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="password" class="form-control" name="password" id="password" placeholder="Your Password" data-rule="email" data-msg="" />
                            <div class="validation"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <button type="submit" class="btn btn-primary btn-submit">FORGOT PASSWORD</button>
                        </div>
                    </div>
                </form>
            </div>
